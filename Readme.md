...
- **Dynamic Project Filtering**: Fast clientside rendering and filtering for 8 categories (Schools, Residential & Commercial, Public Buildings & Hostels, Bungalows/Townships, Banquets, Hospitals, Colleges, Industrial).
